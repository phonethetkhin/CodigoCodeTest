...
import com.codigo.codigocodetest.databinding.FragmentUpcomingMovieBinding
...
/**
 * Fetch and show the upcoming movies
 */
class UpcomingMovieFragment : Fragment(R.layout.fragment_upcoming_movie), DIAware {
    override val di: DI by closestDI()
    private val binding by fragmentViewBinding(FragmentUpcomingMovieBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        (activity as HomeActivity).supportActionBar!!.title = resources.getString(R.string.upcoming)
        homePagingAdapter = HomePagingAdapter(movieDB, requireContext())
        setAdapter()
        observeUpcoming()
        loadingStateHandler()
    ...
    private fun observeUpcoming() {
        lifecycleScope.launch {
            homeViewModel.getUpComing().collect {
